...
const Hero = () => (
	<section className={`flex md:flex-row flex-col ${style.padding}`} id="home">
		<div className={`flex-1 ${style.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
			<div className="flex flex-row items-center py-[6x] px-4 bg-discount-gradient rounded-[10px] mb-2">
